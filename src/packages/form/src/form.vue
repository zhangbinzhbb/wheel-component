...
<template>
  <div id="form">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="ruleForm">
      <el-row>
        <el-col :span="12">
          <el-form-item label="活动名称" prop="name">
            ...
            >
              <i class="el-icon-question label-icon" slot="reference" style="left: -110px;"></i>
            </el-popover>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="活动性质" prop="resource" class="line-error">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="date1" label="时间" error>
            <el-date-picker
              type="date"
              placeholder="选择日期"
